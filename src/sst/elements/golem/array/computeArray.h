...
public:
    ...
    SST_ELI_DOCUMENT_STATISTICS(
        ...
        {"attention_cluster_qk_k_matrix_requests", "Cluster K-tile ingress requests", "requests", 1},
        {"attention_cluster_qk_k_matrix_bytes", "Cluster K-tile ingress bytes", "bytes", 1},
