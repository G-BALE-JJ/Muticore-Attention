...
GOLEM_KEEP_HBM_DUMP_IN_FUSION="${GOLEM_KEEP_HBM_DUMP_IN_FUSION:-0}"
...
if [[ "$GOLEM_OUTPUT_MODE" == "hbm" ]]; then
	...
	if [[ "$GOLEM_KEEP_HBM_DUMP_IN_FUSION" != "1" ]]; then
...
echo "  GOLEM_LOCAL_GM_BYTES_PER_CYCLE=${GOLEM_LOCAL_GM_BYTES_PER_CYCLE:-64}"
...
record = {
    ...
    "local_gm_bytes_per_cycle": os.environ.get("GOLEM_LOCAL_GM_BYTES_PER_CYCLE", "64"),
